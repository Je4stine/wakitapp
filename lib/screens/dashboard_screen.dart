      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Image.asset(ic_store_outline, color: Colors.grey, height: 24), activeIcon: Image.asset(ic_store_fill, color: primaryColor, height: 24), label: languages.lblShop),
          BottomNavigationBarItem(
              icon: Image.asset(ic_report_outline, color: Colors.grey, height: 24), activeIcon: Image.asset(ic_report_fill, color: primaryColor, height: 24), label: languages.lblReport),
